...
1. Download the zipped CNApy Windows installer [from here](https://github.com/cnapy-org/CNApy/releases/download/v1.1.8/cnapy-windows-installer.zip).
...
4. Download the CNApy installation assistant script [from here](https://github.com/cnapy-org/CNApy/releases/download/v1.1.8/cnapy-assistant-script.sh) into the mentioned "condabin" folder.
...
1. Create a conda environment with all dependencies
    ...
    ```sh
    conda create -n cnapy-1.1.8 -c Gurobi -c IBMDecisionOptimization -c conda-forge -c cnapy cnapy=1.1.8 --yes
    ```
