...
class YieldSpaceDialog(QDialog):
    ...
    def __init__(self, appdata):
        ...
        self.x_numerator = QComplReceivLineEdit(self, self.appdata.project.reaction_ids, self.appdata.is_in_dark_mode, check=True)
        ...
        self.y_numerator = QComplReceivLineEdit(self, self.appdata.project.reaction_ids, self.appdata.is_in_dark_mode, check=True)
